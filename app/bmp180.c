 ...
 *
*/
BMP180_RETURN_FUNCTION_TYPE
bmp180_init(struct bmp180_t *bmp180)
{
...
*/
s16
bmp180_get_temperature(u32 v_uncomp_temperature_u32)
{
...
*/
s32
bmp180_get_pressure(u32 v_uncomp_pressure_u32)
{
  s32     v_pressure_s32, 
          v_x1_s32, 
          v_x2_s32,
          v_x3_s32,
          v_b3_s32,
          v_b6_s32 = BMP180_INIT_VALUE;
  u32     v_b4_u32,
          v_b7_u32 = BMP180_INIT_VALUE;
...
//
// hkim additions.
// delay_msec causes a lot of problem in the world of new async programming
// So I am adding async functions.
//
////////////////////////////////////////////////////////////////////////////////
#include "app_common.h"
#include "mainloop_timer.h"

static SoftTimerElem    _bmp180_wait_timer;
static void (*_bmp180_callback)(u32 result) = NULL;

static void
bmp180_schedule_timer(u8 timeout, timer_cb cb)
{
  soft_timer_init_elem(&_bmp180_wait_timer);

  _bmp180_wait_timer.cb = cb;

  mainloop_timer_schedule(&_bmp180_wait_timer, timeout);
}

static void
bmp180_get_uncomp_temperature_callback(SoftTimerElem* te)
{
  u16     v_ut_u16 = BMP180_INIT_VALUE;
  ...
  _bmp180_callback(v_ut_u16);

  (void)v_com_rslt_s8;
}

void
bmp180_get_uncomp_temperature_async(void (*callback)(u32))
{
  /* Array holding the temperature LSB and MSB data*/
  u8      v_ctrl_reg_data_u8 = BMP180_INIT_VALUE;
  ...
  bmp180_schedule_timer(v_wait_time_u8, bmp180_get_uncomp_temperature_callback);
...
static void
bmp180_get_uncomp_pressure_callback(SoftTimerElem* te)
{
  /*j included for loop*/
  u32 v_up_u32          = BMP180_INIT_VALUE;
  BMP180_RETURN_FUNCTION_TYPE v_com_rslt_s8 = E_BMP_COMM_RES;
  ...
  _bmp180_callback(v_up_u32);

  (void)v_com_rslt_s8;
}

void
bmp180_get_uncomp_pressure_async(void (*callback)(u32))
{
  /*get the calculated pressure data*/
  u8 v_ctrl_reg_data_u8   = BMP180_INIT_VALUE;
  ...
  bmp180_schedule_timer(BMP180_2MS_DELAY_U8X + (BMP180_3MS_DELAY_U8X << (p_bmp180->oversamp_setting)),
      bmp180_get_uncomp_pressure_callback);
